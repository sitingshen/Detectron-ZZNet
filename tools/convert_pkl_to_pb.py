...
on CPU, GPU and mobile without depending on the Detectron-ZZnet codebase.
...
def parse_args():
    ...
    parser.add_argument(
        ...
        default="Detectron-ZZnet", type=str)
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        type=int)
    parser.add_argument(
        'opts', help='See Detectron-ZZnet/core/config.py for all options', default=None,
