...
#   from Detectron-ZZnet.core.config import cfg
cfg = __C
...
# Available dataset list: Detectron-ZZnet.datasets.dataset_catalog.datasets()
...
# ---------------------------------------------------------------------------- #
# Data loader options (see Detectron-ZZnet/roi_data/loader.py for more info)
# ---------------------------------------------------------------------------- #
...
__C.DOWNLOAD_CACHE = '/tmp/Detectron-ZZnet-download-cache'
...
# ---------------------------------------------------------------------------- #
_RENAMED_MODULES = {
    'utils.collections': 'Detectron-ZZnet.utils.collections',
}
